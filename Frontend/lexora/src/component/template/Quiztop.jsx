      ...
      <header className="bg-white p-1 shadow-sm z-10 border-b border-gray-200">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:justify-between md:items-center">
          <div className="flex items-center space-x-4">
            <h1 className="text-2xl pl-5 font-bold text-gray-800">Analyzer</h1>
          </div>
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-2">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center space-x-2 text-sm text-gray-500">
            <span className="hover:text-blue-600 cursor-pointer">Skill gap analyzer</span>
            <span>›</span>
            <span className="hover:text-blue-600 cursor-pointer">Choose Your Career Path</span>
            <span>›</span>
            <span className="hover:text-blue-600 cursor-pointer">Quiz</span>
