...
@SpringBootTest
public class SkillBasedIndustryInsights {
...
//		singInButton.click();
        ...
        //Click skill trends button in Sidebar
        WebElement skillTrendButton = wait.until(ExpectedConditions.elementToBeClickable(By.id("SkillTrends")));
        skillTrendButton.click();
